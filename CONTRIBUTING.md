# Contributing to oxidized-chunks
...
```bash
# 1. Fork and clone
git clone https://github.com/oxidized-mc/chunks.git
cd chunks
...
`oxidized-chunks` is a library crate in the
...
Use `chunks` as the scope for all changes to this crate.
